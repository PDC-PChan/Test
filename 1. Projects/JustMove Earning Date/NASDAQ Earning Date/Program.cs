...
namespace NASDAQ_Earning_Date
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            RerunManager rm = new RerunManager();
            ...
            //            {
            //                NewbieManager nb = new NewbieManager(idr.Field<string>("Symbol"));
            //                nb.CreateFiles();
            ...
            //#################################################################################
            //DateTable.Select("Symbol = 'NKE'")[0]["Action"] = FileConnect.RunAction.ReRun;
            //DateTable.Select("Symbol = 'XOM'")[0]["Action"] = FileConnect.RunAction.ReRun;
